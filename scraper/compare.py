#!/usr/bin/env python3
"""Phase 3: Compare drikpanchang-scraped tithis against our reference CSV.
...
Usage:
    python3 compare.py
    python3 compare.py --parsed data/parsed/drikpanchang_lunisolar.csv
...
from config import COMPARISON_REPORT, PARSED_CSV, REF_CSV
...
def compare(parsed_path, ref_path, report_path):
    ...
    if report_path:
        with open(report_path, "w") as f:
            # Write full list in report file
